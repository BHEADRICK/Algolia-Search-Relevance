<?php
/**
 * Algolia_Search_Relevance Test Bootstrapper.
 *
 * @since   0.0.1
 ...
 * @since 0.0.1
 */
function _manually_load_algolia_search_relevance_plugin() {
	...
	// Require our plugin.
	require dirname( dirname( __FILE__ ) ) . '/algolia-search-relevance.php';
}

// Inject in our plugin.
tests_add_filter( 'muplugins_loaded', '_manually_load_algolia_search_relevance_plugin' );
